from Classes.learners import SWUCB_Learner, CUSUM_UCB_Learner, EXP3_Learner
...
conversion_rate_phase3 = np.array([[0.77, 0.48, 0.70],  # 1*price
                                   ...
                                   [0.27, 0.14, 0.28],  # 4*price
                                   [0.24, 0.05, 0.14]  # 5*price
                                   ])

conversion_rate_phase4 = np.array([[0.55, 0.57, 0.71],  # 1*price
                                   [0.31, 0.43, 0.66],  # 2*price
                                   [0.29, 0.41, 0.48],  # 3*price
                                   [0.09, 0.38, 0.22],  # 4*price
                                   [0.08, 0.12, 0.20]  # 5*price
                                   ])

conversion_rate_phase5 = np.array([[0.66, 0.56, 0.62],  # 1*price
                                   [0.34, 0.43, 0.55],  # 2*price
                                   [0.25, 0.39, 0.33],  # 3*price
                                   [0.21, 0.14, 0.29],  # 4*price
                                   [0.09, 0.10, 0.08]  # 5*price
                                   ])
...
for c in classes:
    env_array.append(Non_Stationary_Environment(n_prices, np.array(
        [conversion_rate_phase1[:, c], conversion_rate_phase2[:, c], conversion_rate_phase3[:, c],
         conversion_rate_phase4[:, c], conversion_rate_phase5[:, c]]), c, T, 1))
